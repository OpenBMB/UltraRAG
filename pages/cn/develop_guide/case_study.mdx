...
UR-2.0 提供了便捷的 Case Study 可视化机制，帮助科研人员快速检查与分析所构建的 Pipeline 是否按预期工作。
...
启动成功后，可通过浏览器访问对应地址，进入 Case Study Viewer 界面。该界面以直观的可视化方式展示 Pipeline 各阶段的输入与输出，并支持多模态检索结果（如图像）的同步展示，便于逐步审查推理链条与中间状态。
