...
修改 `examples/parameter/milvus_index_parameter.yaml`，将 Pipeline 链接至您刚才部署的 vLLM 检索服务：

```yaml examples/parameter/milvus_index_parameter.yaml icon="/images/yaml.svg"
retriever:
